#ifndef CLHASH_HEADER_ONLY_H__
#define CLHASH_HEADER_ONLY_H__
#define CLHASH_EXPORT static inline
...
*/
CLHASH_EXPORT uint64_t xorshift128plus(xorshift128plus_key_t * key) {
...
CLHASH_EXPORT void * get_random_key_for_clhash(uint64_t seed1, uint64_t seed2) {
